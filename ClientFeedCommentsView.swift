...
class ClientFeedCommentsView: UIViewController,UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate {
                ...
                if let status = response.response?.statusCode {
                    ...
                    case 200:
                        ...
                        if (response.result.value as AnyObject).value(forKey: "status") as? NSNumber == 0  {
                            ...
                            self.arrMyComments.insert((response.result.value as AnyObject) as! [String : AnyObject], at: 0)
